...
public class S06_SoftwareRasterizer_Finish : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 vertexA = new Vector2(167, 200);
    [SerializeField] private Vector2 vertexB = new Vector2(60, 76);
    [SerializeField] private Vector2 vertexC = new Vector2(154, 60);
    [SerializeField] private Color fillColor = new Color(1f, 0.6f, 0.5f, 1f);

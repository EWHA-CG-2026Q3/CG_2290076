...
public class S06_ImmediateModeTriangle_Finish : MonoBehaviour
{
    ...
    [SerializeField] private Vector3 vertexB = new Vector3(3f, 0f, 0f);
    [SerializeField] private Vector3 vertexC = new Vector3(1.5f, 4f, 0f);
    [SerializeField] private Color triangleColor = new Color(1f, 0.6f, 0.5f, 1f);
